...
class Aggregator():
    ...
    def __init__(self):
        self.data_directory = os.path.join(os.getcwd()[:-8], "data")
        self.load_object()
    ...
    def load_object(self):
        with open(os.path.join(self.data_directory, "berkeley_corpus_without_co\
urses.json"), "r") as fp:
    ...
    def load_course_explorer(self):
        ...
        with open(os.path.join(self.data_directory, "berkeley_course_explorer_d\
ata.json"), "r") as fp: 
            for line in fp.readlines():
                ...
                if c:
                    for index in range(len(c)):
                        c[index].update({"semester": semester, "courseLevel": course_level})
...
#         }
# =============================================================================
        self.output_path = os.path.join(self.data_directory, "berkeley_data.jso\
n")
    ...
    def save_to_file(self):
        with open("{}/berkeley_corpus.json".format(self.data_directory), "w") \
            as file:
